...
import darkStyle from "../stylesheets/components/DarkModeToggle.module.scss";
...
const DarkModeToggle = ({ isDark, onClickMethod }) => (
    <button
        ...
        className={`${isDark ? darkStyle.moon : darkStyle.sun} ${darkStyle.darkModeToggle}`}
    >
        <div className={darkStyle.crescent} />
    </button>
);
