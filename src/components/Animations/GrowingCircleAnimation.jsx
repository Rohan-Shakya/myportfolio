...
import style from "../stylesheets/components/Animations/GrowingCircleAnimation.module.scss"
import { debounce, throttle } from "../../utils/Limitors";

const COLORS = {
    white: "#FFF",
    midnightBlack: "#1e1818",
};
...
const GrowingCircleAnimation = ({ isDark }) => {
    ...
    return <canvas className={style.size} ref={canvasRef} />;
};
